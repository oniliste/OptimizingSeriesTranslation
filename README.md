...
# Task List
1. [Optimizing software in C++:An optimization guide for Windows,Linux adn Mac](https://github.com/Reid-Zheng/OptimizingSeriesTranslation/tree/master/pdf/Optimizing software in C++ An optimization guide for Windows,Linux adn Mac.pdf)
